...
<meta name="keywords" content="404 Error Widget Responsive web template" />
<script type="application/x-javascript"> addEventListener("load", function() { setTimeout(hideURLbar, 0); }, false);
		function hideURLbar(){ window.scrollTo(0,1); } </script>
<!-- //for-mobile-apps -->
<link href="<?php echo asset_url();?>404/css/style.css" rel="stylesheet" type="text/css" media="all" />
...
<body>
	<div class="main">
		...
		<div class="w3l_main_grid">
			<img src="<?php echo asset_url();?>404/images/1.png" alt=" " class="img-responsive" />
		</div>
		...
		<div class="agile_copy_right">
			<p>&copy; 2016 404 Error Widget. All rights reserved | Design by <a href="http://w3layouts.com/">W3layouts</a></p>
		</div>
	</div>
</body>
</html>
